...
public class BshMethod implements Serializable, Cloneable, BshClassManager.Listener {
    ...
    */
        ...
        throws EvalError
    {
        ...
        // Allow registered BshHooks to short-circuit local method calls.
        if ( Interpreter.bshHookManager != null )
        {
            LocalMethodHookParam hookParam =
                Interpreter.bshHookManager.notifyBeforeLocalMethod( name );
            if ( hookParam.isIntercepted )
                return hookParam.returnValue;
        }
        ...
        */
        ...
        if ( ret instanceof ReturnControl ) {
            ...
            // In loose/scripting mode or standard Java, tolerate returning a value from void method instead of throwing fatal exception
